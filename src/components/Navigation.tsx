...
const Navigation = () => {
  ...
  return (
    <div className=" max-w-[1440px] mx-auto flex justify-center items-start">
      <div className="fixed top-0 w-full z-50  flex justify-between items-start">
        <Link
          href="/"
          className="font-montserrat text-sm md:text-base font-bold my-5 ml-5 md:ml-10 lg:ml-14 "
        >
          enovo
        ...
        <div className="flex items-start gap-7 md:gap-10">
          ...
          >
            <button
              ...
              className={`${
                isOpen ? "pl-[20px] md:pr-[70px] py-7" : " px-5 md:px-6 py-2 "
              } overflow-hidden group text-background uppercase tracking-wider text-sm flex flex-col md:items-end justify-center`}
            >
              {isOpen ? "Close" : "menu"}
            </button>

            {isOpen && (
              <div className="text-background  font-montserrat pl-5">
