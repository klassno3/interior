  ...
  return (
    <div className="bg-[#252525]  py-5 md:py-10  px-5 md:px-10 lg:px-14 text-white">
      <div className="max-w-[1440px] mx-auto ">
        <div className="flex gap-5 md:gap-14 lg:gap-20 font-montserrat uppercase text-xs md:text-base lg:text-lg">
          <Link href="/" className="">
            home
          </Link>
        ...
        <div className="flex flex-col-reverse md:flex-row justify-between md:items-end gap-14 pt-14 md:pt-20">
          ...
          <div className="flex flex-col gap-16 md:gap-20">
            <div className="font-montserrat font-light flex flex-col gap-2">
              <div className="uppercase tracking-wide  text-base lg:text-lg ">
                Interest Form
              </div>
        ...
        <div className="flex flex-col md:flex-row md:items-start gap-5 font-thin text-xs lg:text-sm justify-between pt-20  font-montserrat">
          ...
          <div className="uppercase text-center">
            enovo interior design © copyright 2024
          </div>
        </div>
      </div>
    </div>
